 ...
 * @author CharonChui
 */
public class SearchRenderThread extends Thread {
	...
	public SearchRenderThread(ControlPoint mControlPoint) {
		super();
	...
	private DeviceChangeListener mDeviceChangeListener = new DeviceChangeListener() {
		...
		public void deviceRemoved(Device dev) {
			...
			DLNARenderContainer.getInstance().removeDevice(dev);
		}

		@Override
		public void deviceAdded(Device dev) {
			LogUtil.d(TAG, "control point add a device..." + dev.getDeviceType() + dev.getFriendlyName());
			DLNARenderContainer.getInstance().addDevice(dev);
		}
	};
}