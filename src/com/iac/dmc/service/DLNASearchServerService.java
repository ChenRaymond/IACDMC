package com.iac.dmc.service;

import com.iac.dmc.DMCApplication;
...
public class DLNASearchServerService extends Service{

    private static final String TAG = "DLNASearchServerServiceTemp";
    private ControlPoint mControlPoint;
    private SearchServerThread mSearchThread;
    ...
    private void init() {
        mControlPoint = DMCApplication.getInstance().getControlPoint();//new ControlPoint();
        if(mControlPoint == null) {
            mControlPoint = new ControlPoint();
            DMCApplication.getInstance().setControlPoint(mControlPoint);
        }
        mSearchThread = new SearchServerThread(mControlPoint);
