 ...
 * 
 */
public class DLNASearchRenderService extends Service {
    private static final String TAG = "DLNASearchRenderService";
    private ControlPoint mControlPoint;
    private SearchRenderThread mSearchThread;
    ...
    private void init() {
        ...
        mSearchThread = new SearchRenderThread(mControlPoint);
